...
<body>
    <form name="Latihan1" onsubmit="return checkform(this)">
            ...
            <div>
                Hobby
                <input type="checkbox" name="txhobbybola" value="1">Sepak Bola
                <input type="checkbox" name="txhobbybasket" value="2">Bola Basket
                <input type="checkbox" name="txhobbyberenang" value="3">Berenang
            </div>
        ...
        <script>
            function checkform(frm){
                ...
                let hobby = [
                    form.namedItem("txhobbybola").checked,
                    form.namedItem("txhobbybasket").checked,
                    form.namedItem("txhobbyberenang").checked
                ];
                console.log("NIM: "+NIM);
